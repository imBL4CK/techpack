...
ServerEvents.recipes((e) => {
    ...
    const AdvancedRecipes = [
        ...
        },
        {
            ...
            "processingTime": 200,
            "requireEnergy": { perTick: 50 },
            "requireItem": ["techpack:obsidian_glass", "4x techpack:lead_ingot", "techpack:annealed_copper_ingot"],
    ...
    const SophisticatedRecipes = [
        ...
        },
        {
            ...
            "processingTime": 300,
            "requireEnergy": { perTick: 50 },
            "requireItem": ["2x techpack:aluminum_ingot", "techpack:lithium_ingot", "techpack:ptfe_sheet", "#c:glass_blocks", "techpack:flux_infused_alloy_plating"],
            "requireFluid": ["100x techpack:redstone_acid"],
            "produceItem": ["power_armor:battery"],
        },
    ]
