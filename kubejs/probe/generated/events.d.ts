...
declare const CustomMachineryEvents: {
    /**
     * @at *server*
    */
upgrades(handler: (event: Internal.CustomMachineUpgradeJSBuilder$UpgradeEvent) => void):void,
};
...
registry(type: "custommachinery:appearance_property", handler: (event: Registry.AppearanceProperty) => void):void,
registry(type: "custommachinery:component_type", handler: (event: Registry.ComponentType) => void):void,
registry(type: "custommachinery:data_type", handler: (event: Registry.DataType) => void):void,
registry(type: "custommachinery:gui_element_type", handler: (event: Registry.GuiElementType) => void):void,
registry(type: "custommachinery:processor_type", handler: (event: Registry.ProcessorType) => void):void,
registry(type: "custommachinery:requirement_type", handler: (event: Registry.RequirementType) => void):void,
...
registry(type: "scannable:scan_result_provider", handler: (event: Registry.ScanResultProvider) => void):void,
