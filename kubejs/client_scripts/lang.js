ClientEvents.lang("en_us", (event) => {
  ...
  event.renameItem("pipez:universal_pipe", "Cryo-Stabilized Universal Connector");
  event.renameItem("pipez:improved_upgrade", "Basic Connection Module");
  event.renameItem("pipez:advanced_upgrade", "Advanced Connection Module");
