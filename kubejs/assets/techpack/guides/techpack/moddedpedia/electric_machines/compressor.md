...
navigation:
  title: Compressor
  icon: techpack:basic_compressor
  parent: electric_machines/index.md
item_ids:
  - techpack:basic_compressor
---
# Compressor

<BlockImage id="techpack:basic_compressor" scale="3" />

## <Color id="blue">What is the compressor?</Color>
Compressor is a machine added by techpack machines. The Compressor can be used to compress items into new resources. Such 4x snowballs to 1x ice, 4x sand to 1x sandstone, etc
