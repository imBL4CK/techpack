---
navigation: 
  icon: techpack:basic_machine_casing 
  title: Techpack Machines
item_ids: 
  - techpack:speed_modifier
  - techpack:energy_modifier
  - techpack:fuel_efficiency_modifier
  - techpack:luck_modifier
  - techpack:basic_machine_casing
---

# Techlab Machines

<GameScene zoom="3">
  <ImportStructure src="../game_scenes/techpack_machines.nbt" />
</GameScene>
...
![Assembler UI](images/assembler_ui.png)
