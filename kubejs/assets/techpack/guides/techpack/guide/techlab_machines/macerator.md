...
navigation:
  ...
  icon_nbt: '{machine:"custommachinery:industrialrevival/macerator"}'
...
## <Color id="blue">What is the Macerator?</Color>

Macerator is a machine added by Techlab Machines. The Macerator is a machine that requires electrical energy to operate.

Can crush items, ores and blocks. It is can extract some resources from inputs, turns into more useful.
