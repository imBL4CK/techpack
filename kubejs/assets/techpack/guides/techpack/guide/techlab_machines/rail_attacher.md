...
navigation:
  ...
  icon_nbt: '{machine:"custommachinery:industrialrevival/rail_attacher"}'
...
<GameScene zoom="3">
  <ImportStructure src="../game_scenes/rail_attacher.nbt" />
</GameScene>

## <Color id="blue">What is the Rail Attacher?</Color>

Rail Attacher is a machine added by Techlab Machines. The Rail Attacher is a machine that requires electrical energy to operate.

Assembly items into rails, minecarts, acessories and components 
