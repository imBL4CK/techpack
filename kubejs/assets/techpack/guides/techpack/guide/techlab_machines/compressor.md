...
navigation:
  ...
  icon_nbt: '{machine:"custommachinery:industrialrevival/compressor"}'
...
## <Color id="blue">What is the Compressor?</Color>

Compressor is a machine added by Techlab Machines. The Compressor is a machine that requires electrical energy to operate.

The compressor can be used to compress items into new resources. Such as:

* 4x snowballs => 1x Ice
* 1x Tin, Bronze, and Steel => 1x Advanced alloy
* 1x Biomass => 1x Biomass Pallet
