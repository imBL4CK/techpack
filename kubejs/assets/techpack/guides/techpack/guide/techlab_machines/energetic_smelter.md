...
navigation:
  ...
  icon_nbt: '{machine:"custommachinery:industrialrevival/energetic_smelter"}'
...
## <Color id="blue">What is the Energetic Smelter?</Color>

Energetic Smelter is a machine added by Techlab Machines. The Energetic Smelter is a machine that requires electrical energy to operate.

works like a normal furnace, but consumes energy instead of fuel.
