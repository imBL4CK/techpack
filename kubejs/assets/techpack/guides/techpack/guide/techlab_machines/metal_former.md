...
navigation:
  ...
  icon_nbt: '{machine:"custommachinery:industrialrevival/metal_former"}'
...
<GameScene zoom="3">
  <ImportStructure src="../game_scenes/metal_former.nbt" />
</GameScene>

## <Color id="blue">What is the Metal Former?</Color>

Metal Former is a machine added by Techlab Machines. The Metal Former is a machine that requires electrical energy to operate.

Can press ingots into plates.
