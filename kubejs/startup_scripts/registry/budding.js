StartupEvents.registry("block", (e) => {  
  //Sulfur
  e.create("techpack:sulfur_crystal").tagBoth("c:storage_blocks/sulfur").soundType("amethyst").requiresTool(true).tagBoth("mineable/pickaxe").tagBoth("minecraft:needs_iron_tool");
  e.create(`techpack:budding_sulfur`).soundType("amethyst").randomTick((tick) => global.buddingSulfur(tick)).requiresTool(true).tagBoth("mineable/pickaxe").tagBoth("minecraft:needs_iron_tool");
  ...
  //Cinnabar
  e.create("techpack:cinnabar_block").tagBoth("c:storage_blocks/cinnabar").soundType("amethyst").requiresTool(true).tagBoth("mineable/pickaxe").tagBoth("minecraft:needs_iron_tool");
  e.create(`techpack:budding_cinnabar`).soundType("amethyst").randomTick((tick) => global.buddingCinnabar(tick)).requiresTool(true).tagBoth("mineable/pickaxe").tagBoth("minecraft:needs_iron_tool");;
