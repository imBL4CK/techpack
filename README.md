![title image](https://i.imgur.com/eJdyryN.png) ![scenary image](https://i.imgur.com/yAj4RIm.png)

# ⚠ **Alpha Testing**

<span style="color:#e32636">The modpack is in alpha, its content is not complete and bugs are expected, please report them on the Discord server below.</span>
...
![machines](https://i.imgur.com/UfZyv3y.png)
...
![multiblock machines](https://i.imgur.com/zpD3Ncv.png)

# **License**
The TechPack is licensed under the MIT license. You can freely use it to create content, but publishing the Modpack on other Plataforms is strictly prohibited.
